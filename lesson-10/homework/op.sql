...
select E.EmployeeID,D.DepartmentName from Employees E
inner join Departments D on E.DepartmentID=D.DepartmentID

select E.Name emp1,E1.Name, E.ManagerID from Employees E
join Employees E1 on E.EmployeeID=E1.DepartmentID
where E.EmployeeID > E1.EmployeeID and E.ManagerID is not null
...
join Employees E1 on E.EmployeeID=E1.EmployeeID
where E.Salary > (
SELECT
AVG(E1.Salary)
FROM
...
select E.Name,E1.Name,E.ManagerID,E.Salary from Employees E
...
select S.SaleID,P.ProductName,S.SaleAmount SaleAmount from Sales S
